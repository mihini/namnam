  ...
  render() {
      return (
          <div className="App">
              ...
              {this.state.dataLoaded ? <SearchResults showResults={this.state.showResults} restaurantObj={this.state.restaurant} locationLat={this.state.restaurantLocation.lat} locationLng={this.state.restaurantLocation.lng}/> :
              null}
